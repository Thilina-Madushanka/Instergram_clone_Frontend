...
export const createCommentAction = (data) =>async(dispatch)=>{
    ...
    try {
        const res = await fetch(`${BASE_API_URL}/comments/create/${data.postId}`,{
...
export const findPostCommentAction = (data) =>async(dispatch)=>{
    ...
    try {
        const res = await fetch(`${BASE_API_URL}/comments/${data.postId}`,{
...
export const likeCommentAction = (data) =>async(dispatch)=>{
    ...
    try {
        const res = await fetch(`${BASE_API_URL}/comments/like/${data.commentId}`,{
...
export const unLikeCommentAction = (data) =>async(dispatch)=>{
    ...
    try {
        const res = await fetch(`${BASE_API_URL}/comments/unlike/${data.commentId}`,{
