...
export const createPostAction=(data)=>async(dispatch)=>{
    ...
    try {
        const res = await fetch(`${BASE_API_URL}/posts/create`,{
            method:"POST",
            headers:{
...
export const findUserPostAction=(data)=>async(dispatch)=>{
    ...
    try {
        const res = await fetch(`${BASE_API_URL}/posts/following/${data.userIds}`,{
            method:"GET",
            headers:{
                "Content-Type" : "application/json",
                Authorization : "Bearer " + data.jwt
        ...
        console.log("API response for user posts:", posts);
...
export const reqUserPostAction=(data)=>async(dispatch)=>{
    ...
    try {
        const res = await fetch(`${BASE_API_URL}/posts/following/${data.userId}`,{
            method:"GET",
            headers:{
                "Content-Type" : "application/json",
                Authorization : "Bearer " + data.jwt
...
export const likePostAction=(data)=>async(dispatch)=>{
    ...
    try {
        const res = await fetch(`${BASE_API_URL}/posts/like/${data.postId}`,{
            method:"PUT",
            headers:{
                "Content-Type" : "application/json",
                Authorization : "Bearer " + data.jwt
...
export const unLikePostAction=(data)=>async(dispatch)=>{
    ...
    try {
        const res = await fetch(`${BASE_API_URL}/posts/unlike/${data.postId}`,{
            method:"PUT",
            headers:{
                "Content-Type" : "application/json",
                Authorization : "Bearer " + data.jwt
...
export const savePostAction=(data)=>async(dispatch)=>{
    ...
    try {
        const res = await fetch(`${BASE_API_URL}/posts/save_post/${data.postId}`,{
            method:"PUT",
            headers:{
                "Content-Type" : "application/json",
                Authorization : "Bearer " + data.jwt
...
export const unsavePostAction=(data)=>async(dispatch)=>{
    ...
    try {
        const res = await fetch(`${BASE_API_URL}/posts/unsave_post/${data.postId}`,{
            method:"PUT",
            headers:{
                "Content-Type" : "application/json",
                Authorization : "Bearer " + data.jwt
...
export const findPostByIdAction=(data)=>async(dispatch)=>{
    ...
    try {
        const res = await fetch(`${BASE_API_URL}/posts/${data.postId}`,{
            method:"GET",
            headers:{
                "Content-Type" : "application/json",
                Authorization : "Bearer " + data.jwt
...
export const deletePostAction=(data)=>async(dispatch)=>{
    ...
    try {
        const res = await fetch(`${BASE_API_URL}/posts/delete/${data.postId}`,{
            method:"DELETE",
            headers:{
                "Content-Type" : "application/json",
                Authorization : "Bearer " + data.jwt
